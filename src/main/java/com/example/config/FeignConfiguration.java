...
// @Bean
// @Profile("dev")
// public RequestInterceptor oauth2RequestInterceptorDev(OAuth2ClientContext
// oauth2ClientContext) {
// return new Oauth2RequestInterceptor(oauth2ClientContext,
// customOauth2ClientContext, resource());
// }
//
// @Bean
